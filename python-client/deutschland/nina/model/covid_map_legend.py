...
class CovidMapLegend(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, label, properties, *args, **kwargs):  # noqa: E501
        """CovidMapLegend - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, properties, *args, **kwargs):  # noqa: E501
        """CovidMapLegend - a model defined in OpenAPI
