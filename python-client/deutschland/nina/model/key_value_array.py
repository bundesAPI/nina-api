...
class KeyValueArray(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """KeyValueArray - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([KeyValueArrayInner]):  # noqa: E501

        Keyword Args:
            value ([KeyValueArrayInner]):  # noqa: E501
