...
class CovidMap(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "map_legend": ([CovidMapLegend],),  # noqa: E501
            "map_data": ([CovidMapData],),  # noqa: E501
        }
    ...
    attribute_map = {
        "map_legend": "mapLegend",  # noqa: E501
        "map_data": "mapData",  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, map_legend, map_data, *args, **kwargs):  # noqa: E501
        """CovidMap - a model defined in OpenAPI

        Args:
            map_legend ([CovidMapLegend]):
            map_data ([CovidMapData]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, map_legend, map_data, *args, **kwargs):  # noqa: E501
        """CovidMap - a model defined in OpenAPI
