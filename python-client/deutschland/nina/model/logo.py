...
class Logo(ModelNormal):
    ...
    def _from_openapi_data(
        cls, sender_id, name, orientation, last_modification_date, *args, **kwargs
    ):  # noqa: E501
        ...
        Keyword Args:
            ...
            image (str): Dateiname, relativ zu https://warnung.bund.de/api31/appdata/gsb/logos/ (z.B.: https://warnung.bund.de/api31/appdata/gsb/logos/dwd_logo.png). Bei machen Logos nicht definiert.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, sender_id, name, orientation, last_modification_date, *args, **kwargs
    ):  # noqa: E501
        """Logo - a model defined in OpenAPI
