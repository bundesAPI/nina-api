...
class NotfalltippsCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            "category": ([NotfalltippsCategory],),  # noqa: E501
    ...
    def _from_openapi_data(
        cls, category, last_modification_date, *args, **kwargs
    ):  # noqa: E501
        """NotfalltippsCollection - a model defined in OpenAPI

        Args:
            category ([NotfalltippsCategory]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, category, last_modification_date, *args, **kwargs):  # noqa: E501
        """NotfalltippsCollection - a model defined in OpenAPI
