...
def lazy_import():
    ...
    globals()["CovidTickerEntry"] = CovidTickerEntry


class CovidTicker(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CovidTicker - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([CovidTickerEntry]):  # noqa: E501

        Keyword Args:
            value ([CovidTickerEntry]):  # noqa: E501
