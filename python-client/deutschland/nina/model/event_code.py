...
class EventCode(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, event_code, *args, **kwargs):  # noqa: E501
        """EventCode - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            image (str): Dateiname, relativ zu https://warnung.bund.de/api31/appdata/gsb/eventCodes/ (z.B.: https://warnung.bund.de/api31/appdata/gsb/eventCodes/BBK-EVC-001.png).. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, event_code, *args, **kwargs):  # noqa: E501
        """EventCode - a model defined in OpenAPI
