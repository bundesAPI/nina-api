...
class MapWarnings(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MapWarnings - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MapWarningsInner]):  # noqa: E501

        Keyword Args:
            value ([MapWarningsInner]):  # noqa: E501
