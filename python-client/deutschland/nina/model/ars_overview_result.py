...
class ARSOverviewResult(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ARSOverviewResult - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ARSOverviewResultInner]):  # noqa: E501

        Keyword Args:
            value ([ARSOverviewResultInner]):  # noqa: E501
