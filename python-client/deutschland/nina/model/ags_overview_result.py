...
class AGSOverviewResult(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """AGSOverviewResult - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AGSOverviewResultInner]):  # noqa: E501

        Keyword Args:
            value ([AGSOverviewResultInner]):  # noqa: E501
