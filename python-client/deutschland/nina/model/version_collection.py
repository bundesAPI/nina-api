...
class VersionCollection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, version, hash, entries, *args, **kwargs):  # noqa: E501
        """VersionCollection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, version, hash, entries, *args, **kwargs):  # noqa: E501
        """VersionCollection - a model defined in OpenAPI
