...
class NotfalltippsImage(ModelNormal):
    ...
    def _from_openapi_data(
        cls, src, title, alt, last_modification_date, hash, *args, **kwargs
    ):  # noqa: E501
        """NotfalltippsImage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, src, title, alt, last_modification_date, hash, *args, **kwargs
    ):  # noqa: E501
        """NotfalltippsImage - a model defined in OpenAPI
