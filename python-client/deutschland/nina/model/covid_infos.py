...
class CovidInfos(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            "categories": ([CovidInfosCategory],),  # noqa: E501
        }
    ...
    def _from_openapi_data(
        cls, last_modification_date, categories, *args, **kwargs
    ):  # noqa: E501
        """CovidInfos - a model defined in OpenAPI

        Args:
            last_modification_date (datetime): Unix-Zeitstempel der letzten Änderung
            categories ([CovidInfosCategory]):
    ...
    @convert_js_args_to_python_args
    def __init__(
        self, last_modification_date, categories, *args, **kwargs
    ):  # noqa: E501
        """CovidInfos - a model defined in OpenAPI
